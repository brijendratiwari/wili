...
Set @ts = CreateObject("TriggeredSend")
		...
		SetObjectProperty(@sub,"EmailAddress",@email)
		SetObjectProperty(@sub,"SubscriberKey",@email)
		SetObjectProperty(@tsDef, "CustomerKey", "160")
		SetObjectProperty(@ts, "TriggeredSendDefinition", @tsDef)
		
	
		AddObjectArrayItem(@ts, "Subscribers", @sub)
		
		Set @tsstatus = InvokeCreate(@ts, @tsstatusMsg, @tsErrorCode)*/ 
		
		/*Triggered Send Code Ends*/
		]%% -->
    ...
    <div id="brand-img">
      <div class="regs-form">
        <div id="reg-form-heading">
          <p class="heading">Thank you for becoming a member</p>
        </div>
        <div id="reg-form-fields" style="border-bottom:0 !important;">
          <div id="reg-form-fields-wrap"> </div>
        </div>
        <div class="reg-form-submit">
          <div class="reg-form-submit-wrap">
            <p style="margin-top:8px;">We are so glad to have you as part of our family story.<br />
              <br />
              You will be the first to know about our upcoming offers, new releases and special events, so make sure you check your inbox for your newsletter.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div id="footer">
    ...
    <div id="footer-copy-bg">
      <div id="footer-copy-text">
        <p>Full privacy policy can be found at <a href="http://www.brandslaira.com.au/" title="www.brandslaira.com.au" target="_blank">www.brandslaira.com.au</a><br />
          <br />
          &copy; McWilliam's Wines 2014. All rights reserved</p>
      </div>
    </div>
  </div>
</div>
